...
def filed_based_convert_examples_to_features(
    ...
    for (i, label) in enumerate(label_list, 1):
        label_map[label] = i
    with open('/home/zhongyue/model/protein-bert/F_out/label2id.pkl', 'wb') as w:
...
def main(_):
    ...
    if FLAGS.do_train:
        ...
        num_train_steps = int(
            225 / FLAGS.train_batch_size * FLAGS.num_train_epochs)
    ...
    if FLAGS.do_train:
        ...
        tf.logging.info("  Num examples = %d", 225)
    ...
    if FLAGS.do_predict:
        ...
        with open('/home/zhongyue/model/protein-bert/F_out/label2id.pkl', 'rb') as rf:
